...
// WaterTexture/WetTexture simulation (UnFractal.h): half-x-res byte field (row parity ping-pong
// wave automaton) -> displacement bitmap via render table -> out[u] = src[(u + disp[u]) & umask]
