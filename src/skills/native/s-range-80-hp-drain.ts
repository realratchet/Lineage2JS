...
const effects: NativeSkillEffect_T[] = [
    ...
    { phase: "shot", effectClass: "LineageEffect.s_u019_b", host: "target", owner: "target", position: "center", rotation: "targetDisplacement", radiusOffset: -0.5 },
    // 0x7b0577/0x7b05b9: target Location/caster Rotation; 0x7b0663/0x7b066f: speed .1/acceleration 450; path 0x7b06a8..0x7b06d0.
    { phase: "shot", effectClass: "LineageEffect.s_u019_c", host: "target", position: "center", rotation: "caster", projectile: { target: "caster", speed: 0.1, acceleration: 450, path: [[-0.2, 0, 40], [1, 0, 0]] } }
];
