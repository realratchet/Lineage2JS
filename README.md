...
Most of the light is accurate, I'd like to add soundscapes and fix the emitters now. After which I'd like to fix the skinned meshes and skill animations. At some point I would need to do full refactor and overhaul a lot of systems that would impede the implemention of gameplay logic.
